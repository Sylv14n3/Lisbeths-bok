...
% Author
\author{Tekst: Jon, Ulrik, Agnes, Ane, Tor Håkon, Helene, Oline,\\ Simone, Øivind, Ida og Odd\\ Illustrasjoner: Jon, Helene og Oline}
...
\section*{Takk}
Takk til Tor Håkon og Oline for timer med skriving av historier! Det har vært veldig gøy å være med på, og å få oppleve fantasien og skrivegleden dere har.\\
\newline
Takk til Helene og Oline for flotte illustrasjoner.\\
\newline
Takk for fine historier Simone, Ida og Øivind!\\
\newline
Takk for flotte \textit{gullord} om farmor til Ulrik og Agnes\\
\newline
Takk til Odd for hjelp til å finne fram Lisbeths litterære og musikalske karriere.\\
\newline
Takk for alle fine hilsener!
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{illustrasjoner/DalsnesPostkort19001920.PNG}
   \label{Dalsnes1900}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth,angle=90]{illustrasjoner/mammaFjell.jpg}
   \label{MammaFjell}
\end{figure}
\newpage
\section{Mor og Beste}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{illustrasjoner/morFjell2.jpg}
   \label{MorFjell}
\end{figure}
\vspace*{1cm}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{illustrasjoner/morJonAne2.jpg}
   \label{MAJ}
\end{figure}
\vspace*{1cm}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{illustrasjoner/BesteJonAne2.jpg}
   \label{BJA}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{illustrasjoner/jonAneBeste2.jpg}
   \label{BJA2}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{illustrasjoner/aneMammaJon2.jpg}
   \label{BJA2}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{illustrasjoner/KnaskogGodt_Oline.jpg}
   \label{knaskoggodt}
   \caption{Knask og godt av Oline}
\end{figure}
\hfill \newline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth, angle=90]{illustrasjoner/Sinnasinnamonsteret.jpg}
...
\chapter{Gullord om farmor}
I barnehagen har man begrepet \textit{gullord}, her får barna bruke gode ord for å beskrive ett av de andre barna i barnehagen. Jon spurte Ulrik og Agnes om slike \textit{gullord} om farmor og fikk følgende svar:
\newpage
\vspace*{1cm}
\begin{chapquote}{Ulrik}
Grei, snill, hyggelig å gå til stranden, lager gode vafler og ostesmørbrød. Fint å være på hytten og være ute hele dagen, men litt skummelt på natta pga av ulv og bjørn og rev og sånn
\end{chapquote}
\bigskip
\begin{chapquote}{Agnes}
Flink til å bygge ting ute og inne. Gøy med brannbil på hytta. Og på stranda og bade når det er sol! 
\end{chapquote}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\chapter{Hilsener til bursdagsbarnet}
\bigskip
\newpage
\begin{figure}[H]
    \centering
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{illustrasjoner/MAmmaOgUlrik.png}
   \label{FarmorogUlrik}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{illustrasjoner/MammaOgAgnes_2.png}
   \label{FarmorogAgnes}
\end{figure}
\newpage
...
\end{verse}
María Grever (1885 - 1951), med endringer av Ane
\newpage
\vspace*{1cm}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{illustrasjoner/hammock_familie.jpg}
   \label{Hammock}
\end{figure}
\newpage
\vspace*{1cm}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{illustrasjoner/MormorFarmor.jpg}
   \label{MormorFarmor}
\end{figure}
\newpage
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{illustrasjoner/SimoneLucasOmar.jpg}
   \label{Simone}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{illustrasjoner/Portrett_m_hund_3.png}
   \label{Omsorg}
\end{figure}
...
-Odd
\newpage
\section{Hilsen fra Irene og Alf}

\vspace*{1cm}
\begin{chapquote}{Irene og Alf }
Kjære Lisbeth !\\
Du er den aller aller beste og mest trofaste venn vi har.
Du har alltid stilt opp med råd og dåd både for oss og våre barn.
Av hele vårt hjerte vil vi hylle deg på dagen du feirer, og vi ser fram til å få noe tid sammen med deg igjen, men vårt felles paradoks er som pensjonister har tid blitt et knapphetsgode.
